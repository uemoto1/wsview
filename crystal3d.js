...
class Crystal3D {
    ...
    to_cif() {
        ...
        var tmp = "# Generated by Web Salmon View\n";
        tmp += "data_\n";
        tmp += "_symmetry_space_group_name_H-M   'P 1'\n";
        tmp += "_cell_length_a " + (this.vec_a1.length() * au_aa).toFixed(6) + "\n";
        tmp += "_cell_length_b " + (this.vec_a2.length() * au_aa).toFixed(6) + "\n";
        tmp += "_cell_length_c " + (this.vec_a3.length() * au_aa).toFixed(6) + "\n";
        ...
        tmp += "_cell_angle_alpha " + (Math.acos(cos23) / Math.PI * 180.0).toFixed(3) + "\n";
        tmp += "_cell_angle_beta  " + (Math.acos(cos31) / Math.PI * 180.0).toFixed(3) + "\n";
        tmp += "_cell_angle_gamma " + (Math.acos(cos12) / Math.PI * 180.0).toFixed(3) + "\n";
        tmp += "loop_\n";
        ...
        for (var i = 0; i < this.atom_data.length; i++) {
            ...
            tmp += symbol + " " + t1.toFixed(6) + " " + t2.toFixed(6) + " " + t3.toFixed(6) + "\n";
        }
        return tmp;
    }
};
